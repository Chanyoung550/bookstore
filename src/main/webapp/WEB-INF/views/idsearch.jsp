				...
				<section class="login">
					<article class="login__form__container">
						...
						<div class="login__form">
							...
							<!--로고end-->
							<!--아이디찾기 인풋-->
							<form class="login__input" action="/idsearch" method="post" id="signFrm" name="signFrm">
							<!-- <input type="text" name="user_id" placeholder="유저네임" required="required" id="user_id"> -->
								...
								<br/>
								<br/>
								<button type="button" class="btn btn-primary" id="searchId" value="아이디찾기">아이디찾기</button>
								<br/>
...
<script type="text/javascript">
	...
	$("#mail_check").click(function(){
		...
		$.ajax({
	        ...
	        type : "GET",
	        url : "${pageContext.request.contextPath}/mailCntcheck?user_email=" + email + "&user_name=" + name ,
	       	success:function(data){
	       		
	       		if(data == 0) {
	    			alert("이름과 이메일 확인 부탁드립니다.");
	    			$('#user_mail').focus();
